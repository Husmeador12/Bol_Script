...
-----[[ Auto Update Globals ]]------
local version = 3.7
local UPDATE_CHANGE_LOG = "Fixed switcher, Autolevel; added Autoevade Tower"
...
function UpdaterLoad()
    ...
    ToUpdate.ScriptPath =  "/Husmeador12/Bol_Script/master/version/iARAM.lua"
    ToUpdate.SavePath = LIB_PATH.."/iARAM_Test.lua"
    ToUpdate.CallbackUpdate = function(NewVersion,OldVersion) _AutoupdaterMsg("Updated to "..NewVersion.."") end
    ToUpdate.CallbackNoUpdate = function(OldVersion) _AutoupdaterMsg("No Updates Found") end
	--ToUpdate.CallbackNoUpdate = function(OldVersion) _AutoupdaterMsg("<font color=\"#81BEF7\">ChangeLog:</font> "..UPDATE_CHANGE_LOG.."") end
...
print("<font color=\"#9bbcfe\"><b>i<font color=\"#6699ff\">ARAM:</b></font> <font color=\"#FFFFFF\">"..msg..".</font>") 
end
